...
SECRET_KEY = 'django-insecure-o)wbbv0%pz6p7qj!b0^ua8yk#&(jsb@29m_c02x-!_#6y6d5+c'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# --- CONFIGURACIÓN DE SEGURIDAD PARA EL ENTORNO DE DESARROLLO ---
# Permite que el servidor de Django responda a las peticiones del entorno en la nube.
ALLOWED_HOSTS = ['.cloudworkstations.dev', 'localhost', '127.0.0.1']

# Confía en los orígenes del entorno en la nube para evitar errores de CSRF.
...
INSTALLED_APPS = [
    ...
    'gestion', # <-- La app que sí estamos usando
    # 'restaurant', # <-- ELIMINADA LA APP QUE NO EXISTE
    'rest_framework',
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'gestion/static')] # Directorios de estáticos durante el desarrollo
